...
const header = `<a class="skip-link" href="#main">본문으로 바로가기</a>
    <header class="site-header is-scrolled" data-header data-solid-header>
      <a class="wordmark" href="../index.html#home" aria-label="건지울른스 홈"><span>건지울른스</span><small>GUERNSEY WOOLLENS</small></a>
...
const footer = `<footer class="site-footer"><a class="wordmark wordmark--footer" href="../index.html#home"><span>건지울른스</span><small>GUERNSEY WOOLLENS</small></a><p>섬의 태도와 오래 입는 옷.</p><nav class="footer-links" aria-label="푸터 연락 링크"><a href="mailto:hello@geonjiulleuns.kr" target="_blank" rel="noopener noreferrer">이메일</a><a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer">SNS</a></nav><p>© <span data-year></span> GUERNSEY WOOLLENS</p></footer>`;
